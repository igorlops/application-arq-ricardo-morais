            ...
            <div class="flex flex-col md:flex-row items-center gap-16">
                ...
                <div class="w-full md:w-5/12 reveal">
                    <div class="relative p-6">
                        ...
                        <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=1974&auto=format&fit=crop" alt="Arquiteto Ricardo Morais" class="relative z-10 w-full object-cover grayscale hover:grayscale-0 transition-all duration-700 shadow-xl max-h-[600px]">
                    </div>
                </div>
