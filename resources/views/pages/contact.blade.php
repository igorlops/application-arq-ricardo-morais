                ...
                <div class="bg-brand-dark p-12 md:p-16 text-white">
                    <div class="reveal">
                        ...
                        <div class="mt-12 flex gap-4">
                            ...
                            <a href="#" class="w-12 h-12 border border-white/20 flex items-center justify-center text-white hover:bg-brand-gold hover:border-brand-gold hover:text-theme-primary transition-all">
