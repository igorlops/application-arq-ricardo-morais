<x-app-layout>
    ...
    <section class="relative py-32 md:py-48 bg-brand-dark overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/launge-arquiteto-fortaleza.jpeg') }}" alt="Projetos Comerciais" class="w-full h-full object-cover opacity-30 filter grayscale">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div class="flex items-center justify-center gap-4 mb-6 reveal">
                ...
                <p class="text-brand-gold uppercase tracking-[0.3em] text-xs font-semibold">Soluções Corporativas</p>
                <div class="h-px w-12 bg-brand-gold"></div>
            </div>
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-6 reveal delay-100">Projetos <span class="italic text-brand-gold">Comerciais</span></h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
                ...
                <div class="reveal delay-200 img-zoom-hover relative">
                    ...
                    <img src="{{ asset('images/projeto-arquitetura-fortaleza-design.jpeg') }}" alt="Escritório Moderno" class="w-full h-[500px] object-cover shadow-2xl filter grayscale contrast-125 relative z-10">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div class="reveal delay-200 order-1 md:order-2 img-zoom-hover relative">
                    <div class="absolute -inset-4 border-2 border-brand-gold/30 z-0 hidden md:block"></div>
                    <img src="{{ asset('images/arquitetura-fortaleza-ricardo-morais.jpeg') }}" alt="Interior Comercial" class="w-full h-[500px] object-cover shadow-2xl filter grayscale contrast-125 relative z-10">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-32 bg-brand-dark relative overflow-hidden">
        <div class="absolute inset-0 opacity-20">
            <img src="{{ asset('images/launge-arquiteto-fortaleza.jpeg') }}" alt="Background" class="w-full h-full object-cover">
        </div>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            <i data-lucide="building-2" class="w-16 h-16 text-brand-gold mx-auto mb-8"></i>
            <h2 class="text-4xl md:text-5xl font-serif text-white mb-6">Elevando seu <span class="italic text-brand-gold">negócio</span></h2>
